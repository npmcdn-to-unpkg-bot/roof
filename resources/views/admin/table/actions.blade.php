<form action="{{ route($links['delete'], $item) }}" method="POST">
	...
	<button name="_method" value="DELETE" class="btn btn-sm btn-danger" data-toggle="tooltip" data-original-title="Удалить"><span class="glyphicon glyphicon-remove"></span> </button>
</form>
