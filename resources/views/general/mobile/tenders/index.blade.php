	...
	<div class="container">
		<div class="container__row">
			<div class="container__col-8">
				...
				@include('general.mobile.pagenav',['items'=>$tenders])

			</div>
			<div class="container__col-4">
				@include('general.mobile.events.block')
				<div class="offset_vertical_55">@include('general.mobile.area.banner',['area' => 'Тендеры архив 1'])</div>
				<div class="offset_vertical_55">@include('general.mobile.polls.block')</div>
				<div class="offset_vertical_55">@include('general.mobile.area.banner',['area' => 'Тендеры архив 2'])</div>
			</div>
		</div>
	</div>
