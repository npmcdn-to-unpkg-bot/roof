...
@section('content')
	...
	<div class="offset_vertical_40">
		@include('general.mobile.catalog.association')
	</div>
		...
		<div class="container__row">
			<div class="container__col-8">
				@foreach ($companies as $i=>$company)
					...
					@if ($i==5) 
						@include('general.mobile.area.banner',['area' => 'Каталог архив 2'])
					@endif
				@endforeach
				@include('general.mobile.pagenav',['items'=>$companies])
			...
			<div class="container__col-4">
				...
				@endif
				<div class="offset_bottom_60">@include('general.mobile.area.banner',['area' => 'Каталог архив 1'])</div>
				<div class="offset_bottom_60">@include('general.mobile.forum.block')</div>
				<div class="offset_bottom_60">@include('general.mobile.events.block')</div>
				<div class="offset_bottom_60">@include('general.mobile.polls.block')</div>
			</div>
		</div>
	</div>
