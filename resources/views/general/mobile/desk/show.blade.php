	...
	<div class="container">
		<div class="container__row">
			...
			<div class="container__col-4">
				...
				<div class="offset_vertical_55">@include('general.mobile.area.banner',['area' =>'Объявления запись 1'])</div>
				<div class="offset_vertical_55">@include('general.mobile.area.banner',['area' => 'Объявления запись 2'])</div>
			</div>
		</div>
	</div>
