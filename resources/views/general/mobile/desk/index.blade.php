	...
	<div class="container">
		<div class="container__row">
			<div class="container__col-8">
				...
				@include('general.mobile.desk.top')
				...
				@include('general.mobile.pagenav',['items'=>$offers])
			...
			<div class="container__col-4">
				...
				<div class="offset_vertical_55">@include('general.mobile.area.banner',['area' => 'Объявления архив 1'])</div>
				<div class="offset_vertical_55">@include('general.mobile.area.banner',['area' => 'Объявления архив 2'])</div>
			</div>
		</div>
	</div>
