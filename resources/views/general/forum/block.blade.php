...
<div class="forum-message">
	...
	<?php foreach ($posts as $post): ?>
		<div class="forum-message__item">
			...
			<a target="_blank" href="http://forum.roofers.com.ua/memberlist.php?mode=viewprofile&u=<?php echo $post['poster_id'] ?>" class="forum-message__name"><?php echo $post['user']['username'] ?></a><span class="forum-message_post-date"><?php echo $post['post_time'] ?></span>
			<div class="forum-message__text"><?php echo $post['post_text'] ?></div>
			<a target="_blank" href="http://forum.roofers.com.ua/viewtopic.php?f=<?php echo $post['forum_id'] ?>&t=<?php echo $post['topic_id'] ?>" class="forum-message__theme"><?php echo $post['post_subject'] ?></a>
		</div>
	<?php endforeach ?>
</div>