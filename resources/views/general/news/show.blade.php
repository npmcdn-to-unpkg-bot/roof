	...
	<div class="container">
		<div class="container__row">
			...
			<div class="container__col-4">
				...
				<div class="offset_vertical_55">@include('general.area.banner',['area' => 'Новости запись 1'])</div>
				<div class="question offset_vertical_55">@include('general.polls.block')</div>
				<div class="offset_vertical_55">@include('general.area.banner',['area' => 'Новости запись 2'])</div>
			</div>
		</div>
	</div>
