	...
	<div class="page-tabs">
		...
		<div class="container offset_vertical_60">
			...
			<form action="" class="offset_vertical_15">
				<select style="width: 280px;" name="speciality" class="input_select input offset-sm_vertical_15">
				...
				<select style="width: 170px;" name="seasonality" class="input_select input offset-sm_vertical_15">
