	...
	<div class="container">
		<div class="container__row">
			<div class="container__col-8">
				...
				@include('general.desktop.desk.top')
			</div>
			<div class="container__col-4">
				...
				<div class="offset_vertical_55">@include('general.desktop.area.banner',['area' =>'Объявления запись 1'])</div>
				<div class="offset_vertical_55">@include('general.desktop.area.banner',['area' => 'Объявления запись 2'])</div>
			</div>
		</div>
	</div>
	@include('general.desktop.news.block2')
@endsection