	...
	<div class="container">
		<div class="container__row">
			<div class="container__col-8">
				...
				@include('general.desktop.pagenav',['items'=>$sales])

			</div>
			<div class="container__col-4">
				@include('general.desktop.area.banner',['area' => 'Акции архив 1'])
				<div class="offset_vertical_55">
					@include('general.desktop.area.banner',['area' => 'Акции архив 2'])
				</div>
			</div>
		</div>
	</div>
