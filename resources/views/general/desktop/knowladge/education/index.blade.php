...
<div class="container">
	<div class="container__row masonry">
		@foreach ($posts as $i => $post)
			...
			@if ($i==1) <div class="container__col-4 offset_bottom_45">@include('general.desktop.area.banner',['area' => 'Обучение архив 1'])</div> @endif
		@endforeach
		@if ($posts->count() < 2) <div class="container__col-4 offset_bottom_45">@include('general.desktop.area.banner',['area' => 'Обучение архив 1'])</div> @endif
	</div>
