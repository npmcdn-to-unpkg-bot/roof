...
<div class="container offset_bottom_60">
	<div class="container__row">
		<div class="container__col-8 container__col-sm-12 post-page">
			...
			<div class="post-page__content">
				...
				<div class="container__row offset_vertical_60 offset-sm_vertical_60">
					<div class="container__col-6 container__col-sm-6">
						@if($post->prev())
						<a href="{{route('knowladge.library.show', $post->prev())}}" class="market-news__other">< ПРЕДЫДУЩАЯ СТАТЬЯ</a>
						@endif
					</div>
					<div class="container__col-6 container__col-sm-6 text_right">
						@if($post->next())
						<a href="{{route('knowladge.library.show', $post->next())}}" class="market-news__other">СЛЕДУЮЩАЯ СТАТЬЯ ></a>
						@endif
					</div>
				</div>
			</div>
			...
			@if(Agent::isMobile()) @include('general.knowladge.library.related') @endif
		</div>
